!function(t, e, n, o) {
    ...
    n) {
        if (n.fn.fancyboxdha)
            return void console.info("dohomeart fancyboxdha already initialized");
        var a = {
            closeExisting: !1,
            loop: !1,
            gutter: 50,
        ...
        n.extend(b.prototype, {
            init: function() {
                ...
                !n.fancyboxdha.getInstance() && !1 !== r.hideScrollbar && !n.fancyboxdha.isMobile && e.body.scrollHeight > t.innerHeight && (n("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar{margin-right:' + (t.innerWidth - e.documentElement.clientWidth) + "px;}</style>"),
                n("body").addClass("compensate-for-scrollbar")),
                i = "",
                n.each(r.buttons, function(t, e) {
                    i += r.btnTpl[e] || ""
                }),
                o = n(a.translate(a, r.baseTpl.replace("{{buttons}}", i).replace("{{arrows}}", r.btnTpl.arrowLeft + r.btnTpl.arrowRight))).attr("id", "fancybox-container-" + a.id).addClass(r.baseClass).data("fancyboxdha", a).appendTo(r.parentEl),
                a.$refs = {
                    container: o
                },
            ...
            revealContent: function(t) {
                ...
                a && (l.opacity = .1,
                c.opacity = 1),
                n.fancyboxdha.setTranslate(t.$content.removeClass("fancybox-is-hidden"), l),
                p(t.$content),
                ...
                void n.fancyboxdha.animate(r, "fancybox-slide--current", i, function() {
                    r.removeClass(o).css({
                        transform: "",
                        opacity: ""
                    }),
            ...
            close: function(t, e) {
                ...
                !0) : (o && i ? n.fancyboxdha.animate(f.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + o, i, h) : !0 === t ? setTimeout(h, i) : h(),
                !0)))
            },
            cleanUp: function(e) {
        ...
        n.fancyboxdha = {
            ...
            getInstance: function(t) {
                var e = n('.fancybox-container:not(".fancybox-is-closing"):last').data("fancyboxdha")
        ...
        r.on("click.fb-start", "[data-fancybox-trigger]", function(t) {
            n('[data-fancyboxdha="' + n(this).attr("data-fancybox-trigger") + '"]').eq(n(this).attr("data-fancybox-index") || 0).trigger("click.fb-start", {
                $trigger: n(this)
            })
        }),
        function() {
...
function(t, e, n) {
    console.log("function(t, e, n) no 1");
    "use strict";
    var o = function() {
        return t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || function(e) {
            return t.setTimeout(e, 1e3 / 60)
    ...
    d.prototype.ontouchstart = function(o) {
        ...
        (!o.originalEvent || 2 != o.originalEvent.button) && f.length && c.length && !r(c) && !r(c.parent()) && (c.is("img") || !(o.originalEvent.clientX > c[0].clientWidth + c.offset().left))) {
            ...
            n.fancyboxdha.isMobile && c.parents(".fancybox-caption").length)) && (i.isScrollable = l(c) || l(c.parent()),
...
function(t, e) {
    console.log("function(t, e) no 3");
    "use strict";
    var n = "fancybox-thumbs";
    e.fancyboxdha.defaults = e.extend(!0, {
        btnTpl: {
            thumbs: '<button data-fancyboxdha-thumbs class="fancybox-button fancybox-button--thumbs" title="{{THUMBS}}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M14.59 14.59h3.76v3.76h-3.76v-3.76zm-4.47 0h3.76v3.76h-3.76v-3.76zm-4.47 0h3.76v3.76H5.65v-3.76zm8.94-4.47h3.76v3.76h-3.76v-3.76zm-4.47 0h3.76v3.76h-3.76v-3.76zm-4.47 0h3.76v3.76H5.65v-3.76zm8.94-4.47h3.76v3.76h-3.76V5.65zm-4.47 0h3.76v3.76h-3.76V5.65zm-4.47 0h3.76v3.76H5.65V5.65z"/></svg></button>'
        },
        thumbs: {
            autoStart: !1,
            hideOnClose: !0,
    ...
    e.extend(o.prototype, {
        ...
        init: function(t) {
            ...
            t.Thumbs = e,
            e.$button = t.$refs.toolbar.find("[data-fancybox-thumbsdha]");
        ...
        create: function () {
            if (!o.$list) {
                ...
                o.$grid || (o.$grid = e('<div class="' + n + " " + n + "-" + o.opts.axis + '"></div>').appendTo(i.$refs.container.find(a).addBack().filter(a)),
                    ...
                    o.$list || (o.$list = e('<div class="' + n + '__listdha">').appendTo(o.$grid));
                ...
                e.each(i.group, function (e, n) {
                    ...
                    // Check if the background-image is already added
                    var isDuplicateImage = backgroundImages.some(function (url) {
                        return url === t;
                    });

                    if (!isDuplicateImage) {
                        backgroundImages.push(t);
...
function(t, e, n) {
    console.log("function(t, e, n) no 2");
    "use strict";
    function o() {
    ...
    function a(t) {
        ...
        "" !== (n = e.hash || (e.$orig ? e.$orig.data("fancyboxdha") || e.$orig.data("fancybox-trigger") : "")) && n)
    }
