        ...
        create: function() {
            if (!o.$list) {
                ...
                e.each(i.group, function(e, n) {
                    ...
                    // Check if the element with the same data-index already exists
                    var existingElement = o.$list.find('[data-index="' + e + '"]');
...
function(t, e, n) {
    ...
    function i(t) {
        "" !== t.gallerydha && n("[data-fancyboxdha='" + n.escapeSelector(t.gallerydha) + "']").eq(t.index - 1).focus().trigger("click.fb-start")
    }
    function a(t) {
        var e, n;
    ...
    n(function() {
        !1 !== n.fancyboxdha.defaults.hash && (n(e).on({
            "onInit.fb": function(t, e) {
                ...
                (i = a(e)) && n.gallerydha && i == n.gallerydha && (e.currIndex = n.index - 1))
            },
        ...
        n(t).on("hashchange.fb", function() {
            ...
            e ? e.currentHash === t.gallerydha + "-" + t.index || 1 === t.index && e.currentHash == t.gallerydha || (e.currentHash = null,
            e.close()) : "" !== t.gallerydha && i(t)
        }),
        setTimeout(function() {
