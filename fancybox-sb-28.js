!function(t, e, n, o) {
    ...
    n) {
        ...
        var a = {
            ...
            slideClass: "",
            baseClass: "",
            baseTpl: '<div class="fancyboxdha-container" role="dialog" tabindex="-1"><div class="fancyboxdha-bg"></div><div class="fancyboxdha-inner"><div class="fancyboxdha-albumTitle"></div><div class="fancyboxdha-infobar">File <span data-fancyboxdha-index></span>&nbsp;/&nbsp;<span data-fancyboxdha-count></span></div><div class="fancyboxdha-toolbar">{{buttons}}</div><div class="fancyboxdha-navigation">{{arrows}}</div><div class="fancyboxdha-stage"></div><div class="fancyboxdha-caption"><div class="fancyboxdha-caption__body"></div></div></div></div>',
        ...
        n.extend(b.prototype, {
            ...
            setContent: function(t, e) {
                ...
                t.$slide.empty(),
                l(e) && e.parent().length ? ((e.hasClass("fancyboxdha-content") || e.parent().hasClass("fancyboxdha-content")) && e.parents(".fancybox-slide").trigger("onReset"),
